package com.anningtex.testblutooth;
...
public class BTClientActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //设置画面为主画面
        setContentView(R.layout.ble_activity_bt_client);
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(BTClientActivity.this, smsg, Toast.LENGTH_SHORT).show();
  ...
  /*  @Override
    ...
    private void Save() {
        ...
        final View DialogView = factory.inflate(R.layout.ble_sname, null);  //用sname.xml模板生成视图模板
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                try {
                                    if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {  //如果SD卡已准备好
                                        ...
                                        stream.close();
                                        Toast.makeText(BTClientActivity.this, "存储成功！\n\r" + saveFile, Toast.LENGTH_LONG).show();
                                    } else {
